...
<body>
    ...
    <div class="navbar" id="navbar">
        ...
        <div class="navbar-links">
            <a href="study admin.php" class="logo">Study Buddy</a>
        </div>
        <a href="profile.php" class="logout"><?php echo htmlspecialchars($_SESSION['USERNAME']); ?></a>
    </div>
  
    <div class="subject-container" id="subject-container" display="hidden">
    <?php
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<a href='studyrev admin.php'>Go to class</a>";
                echo "<div class='three-dots' onclick='toggleDropdown(this)'>⋮</div>";
                echo "<div class='dropdown-menu'>";
                echo "<button onclick='editSubjectCard(this, " . $row['SUB_ID'] . ")'>Edit</button>";
    ...
    ?>
        ...
        <div class="add-subject-form" id="add-subject-form">
            ...
            <input type="text" id="subject-title" placeholder="Subject Title" required>
            <input type="text" id="subject-desc" placeholder="Subject Description" required>
    ...
    <script>
        ...
        function editSubjectCard(buttonElement, subId) {
            ...
            if (newTitle !== null && newDescription !== null) {
                ...
                xhr.open("POST", "edit_subject.php", true);
                xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");

                
                xhr.send("sub_id=" + subId + "&title=" + encodeURIComponent(newTitle) + "&description=" + encodeURIComponent(newDescription));
                    ...
                    if (xhr.readyState === 4) {
                        if (xhr.status === 200) {
                            if (xhr.responseText.trim() === "success") {
                                ...
                                alert("Error updating the subject: " + xhr.responseText);
                            }
                        } else {
